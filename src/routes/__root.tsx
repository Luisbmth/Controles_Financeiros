...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Saldo · Controle de Contas" },
      ...
      { property: "og:title", content: "Saldo · Controle de Contas" },
      { property: "og:description", content: "Substitua sua planilha de contas. Lembretes, recorrentes, parceladas." },
